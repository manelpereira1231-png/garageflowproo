...
const VEHICLE_DATA: Record<string, { logo: string; models: string[] }> = {
  ...
  "Mercedes-Benz": { logo: "https://cdn.simpleicons.org/mercedes", models: ["Classe A", "Classe B", "Classe C", "Classe E", "Classe S", "CLA", "CLS", "GLA", "GLB", "GLC", "GLE", "GLS", "EQA", "EQB", "EQC", "EQE", "EQS", "AMG GT", "SL"] },
  ...
  "Toyota": { logo: "https://cdn.simpleicons.org/toyota", models: ["Yaris", "Yaris Cross", "Corolla", "Camry", "C-HR", "RAV4", "Highlander", "Land Cruiser", "Hilux", "Supra", "GR86", "Aygo X", "bZ4X", "Proace"] },
