  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-3xl mx-auto px-4 py-10 prose prose-slate dark:prose-invert">
        ...
        <p>
          Estes Termos regem-se pela lei portuguesa. Para qualquer litígio é competente o foro da
          comarca de Lisboa, com renúncia expressa a qualquer outro.
        </p>
        <p>
          Pode também recorrer a meios alternativos de resolução de litígios através do portal
          europeu ODR: <a href="https://ec.europa.eu/consumers/odr" target="_blank" rel="noreferrer">ec.europa.eu/consumers/odr</a>.
        </p>
