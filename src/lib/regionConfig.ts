...
const STATIC_COUNTRIES: Record<string, CountryConfig> = {
  PT: {
    ...
    stripe: {
      proMonthly: 'price_1TqzvYKIsGuKgNEHKClzwOV9',
      proYearly: 'price_1TqzvZKIsGuKgNEHhApnFUJ4',
      garageMonthly: 'price_1TqzvbKIsGuKgNEHcj52SHIV',
      garageYearly: 'price_1TqzvcKIsGuKgNEH4dWeTbaV',
    },
    active: true,
  },
  BR: {
