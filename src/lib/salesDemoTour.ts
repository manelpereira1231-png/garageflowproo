...
export const TOUR: TourStep[] = [
  ...
  },
  {
    ...
    stage: "vehicle",
    area: "Viatura",
    context: `A viatura do ${DEMO_CASE.client}: ${DEMO_CASE.vehicle} (${DEMO_CASE.plate}).`,
    before: "A partir da ficha do cliente abrimos a viatura em causa.",
  ...
  },
  {
    ...
    stage: "history",
    area: "Histórico",
    context: `Tudo o que já foi feito nesta viatura (${DEMO_CASE.plate}).`,
  ...
  },
  {
    ...
    stage: "quote",
    area: "Orçamento",
    context: `Orçamento ${DEMO_CASE.quote} para ${DEMO_CASE.job}, criado a partir da viatura.`,
  ...
  },
  {
    ...
    before: "Trabalho concluído, viatura entregue e faturada.",
