...
import { Search, ShieldCheck, Car, Fuel, Calendar, Gauge, ArrowRight, CheckCircle, Eye, Wrench, MapPin, FileCheck, TrendingUp, Heart, SlidersHorizontal, X, RotateCcw, Sparkles, Building2, Package, User } from "lucide-react";
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="order-1 md:order-2">
              ...
              <div className="flex flex-wrap gap-3">
                <Link to="/market/auth?mode=signup&account=dealer&redirect=/market/dealer-dashboard">
