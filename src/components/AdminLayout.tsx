...
const navSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: "/admin/market?tab=escrow", label: "Escrow & Reembolsos", icon: Wallet },
      ...
      { path: "/admin/market?tab=shops", label: "Oficinas Market", icon: Building2 },
      { path: "/admin/market?tab=boosts", label: "Boosts & Destaques", icon: Megaphone },
      { path: "/admin/market?tab=disputes", label: "Disputas & Chat", icon: MessageCircle },
