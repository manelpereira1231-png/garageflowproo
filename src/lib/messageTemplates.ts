...
export const messageTemplates: MessageTemplate[] = [
  ...
  },
  {
    ...
    body: "Order {{wo_number}}\n\nHello {{client_name}},\n\nWe inform you that the quote for your Order {{wo_number}} for the vehicle {{vehicle}} ({{plate}}) has been approved.\n\nApproved amount: €{{quote_total}}\n\nOur team will start the intervention very soon.\n\nAs soon as the work begins, you will receive a new update.\n\nThank you for your trust.",
    bodyPt: "Ordem de Serviço {{wo_number}}\n\nOlá {{client_name}},\n\nInformamos que o orçamento da sua Ordem de Serviço para o veículo {{vehicle}} ({{plate}}) foi aprovado.\n\nValor aprovado: €{{quote_total}}\n\nA nossa equipa irá iniciar a intervenção muito em breve.\n\nAssim que os trabalhos começarem, receberá uma nova atualização.\n\nObrigado pela sua confiança.",
