...
async function seed(admin: any, shopId: string) {
  const clients = [
    ...
    { name: "Transportes Belém, Lda.", phone: "+351 927 332 810", email: "contact@garageflow.pt", company: "Transportes Belém", nif: "510000002", is_fleet: true, fleet_name: "Frota Belém" },
    { name: "Rui Cardoso", phone: "+351 934 368 304", email: "contact@garageflow.pt", nif: "210000003" },
    { name: "Sofia Almeida", phone: "+351 927 332 810", email: "contact@garageflow.pt", nif: "210000004" },
    { name: "Miguel Tavares", phone: "+351 934 368 304", email: "contact@garageflow.pt", nif: "210000005" },
  ...
  const appointments = [
    { vehicle: anaVehicle, date: dateFromNow(1), time: "09:00", service_type: "Revisão periódica", duration_minutes: 90, status: "confirmed", client_name: "Ana Marques", client_phone: "+351 934 368 304", client_email: "contact@garageflow.pt" },
    { vehicle: fleetVehicle, date: dateFromNow(1), time: "11:00", service_type: "Diagnóstico de ruído", duration_minutes: 60, status: "scheduled", client_name: "Transportes Belém, Lda.", client_phone: "+351 927 332 810", client_email: "contact@garageflow.pt" },
    { vehicle: sofiaVehicle, date: dateFromNow(2), time: "15:30", service_type: "Teste de bateria", duration_minutes: 45, status: "pending", client_name: "Sofia Almeida", client_phone: "+351 927 332 810", client_email: "contact@garageflow.pt", source: "portal" },
