...
export const SEO_CITIES = [
  ...
  // Grande Lisboa
  { slug: "almada", name: "Almada", region: "Península de Setúbal" },
  { slug: "amadora", name: "Amadora", region: "Grande Lisboa" },
  { slug: "cascais", name: "Cascais", region: "Grande Lisboa" },
  { slug: "sintra", name: "Sintra", region: "Grande Lisboa" },
  { slug: "oeiras", name: "Oeiras", region: "Grande Lisboa" },
  { slug: "loures", name: "Loures", region: "Grande Lisboa" },
  { slug: "odivelas", name: "Odivelas", region: "Grande Lisboa" },
  { slug: "vila-franca-de-xira", name: "Vila Franca de Xira", region: "Grande Lisboa" },
  { slug: "mafra", name: "Mafra", region: "Grande Lisboa" },
  { slug: "torres-vedras", name: "Torres Vedras", region: "Oeste" },
  { slug: "barreiro", name: "Barreiro", region: "Península de Setúbal" },
  { slug: "seixal", name: "Seixal", region: "Península de Setúbal" },
  { slug: "montijo", name: "Montijo", region: "Península de Setúbal" },
  { slug: "palmela", name: "Palmela", region: "Península de Setúbal" },
  // Grande Porto / Norte
  { slug: "vila-nova-de-gaia", name: "Vila Nova de Gaia", region: "Grande Porto" },
  { slug: "matosinhos", name: "Matosinhos", region: "Grande Porto" },
  { slug: "maia", name: "Maia", region: "Grande Porto" },
  { slug: "gondomar", name: "Gondomar", region: "Grande Porto" },
  { slug: "valongo", name: "Valongo", region: "Grande Porto" },
  { slug: "povoa-de-varzim", name: "Póvoa de Varzim", region: "Grande Porto" },
  { slug: "vila-do-conde", name: "Vila do Conde", region: "Grande Porto" },
  { slug: "santo-tirso", name: "Santo Tirso", region: "Grande Porto" },
  { slug: "paredes", name: "Paredes", region: "Tâmega" },
  { slug: "paços-de-ferreira", name: "Paços de Ferreira", region: "Tâmega" },
  { slug: "felgueiras", name: "Felgueiras", region: "Tâmega" },
  { slug: "penafiel", name: "Penafiel", region: "Tâmega" },
  { slug: "vila-nova-de-famalicao", name: "Vila Nova de Famalicão", region: "Minho" },
  { slug: "barcelos", name: "Barcelos", region: "Minho" },
  { slug: "viana-do-castelo", name: "Viana do Castelo", region: "Minho" },
  { slug: "vila-real", name: "Vila Real", region: "Trás-os-Montes" },
  ...
  { slug: "tomar", name: "Tomar", region: "Centro" },
  { slug: "torres-novas", name: "Torres Novas", region: "Centro" },
  { slug: "santarem", name: "Santarém", region: "Ribatejo" },
  { slug: "caldas-da-rainha", name: "Caldas da Rainha", region: "Oeste" },
  { slug: "marinha-grande", name: "Marinha Grande", region: "Centro" },
  { slug: "figueira-da-foz", name: "Figueira da Foz", region: "Centro" },
  // Alentejo / Algarve
  { slug: "beja", name: "Beja", region: "Alentejo" },
  { slug: "portalegre", name: "Portalegre", region: "Alentejo" },
  { slug: "elvas", name: "Elvas", region: "Alentejo" },
  { slug: "sines", name: "Sines", region: "Alentejo Litoral" },
  { slug: "portimao", name: "Portimão", region: "Algarve" },
  { slug: "loule", name: "Loulé", region: "Algarve" },
  { slug: "albufeira", name: "Albufeira", region: "Algarve" },
  { slug: "lagos", name: "Lagos", region: "Algarve" },
  { slug: "olhao", name: "Olhão", region: "Algarve" },
  { slug: "tavira", name: "Tavira", region: "Algarve" },
  { slug: "silves", name: "Silves", region: "Algarve" },
  // Ilhas
  { slug: "ponta-delgada", name: "Ponta Delgada", region: "Açores" },
  { slug: "angra-do-heroismo", name: "Angra do Heroísmo", region: "Açores" },
  { slug: "camara-de-lobos", name: "Câmara de Lobos", region: "Madeira" },
];
